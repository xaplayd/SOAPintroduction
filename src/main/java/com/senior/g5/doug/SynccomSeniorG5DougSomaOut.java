...
/**
 * <p>Classe Java de Synccom.senior.g5.dougSomaOut complex type.</p>
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.</p>
 * 
 * <pre>{@code
 * <complexType name="Synccom.senior.g5.dougSomaOut">
 *   <complexContent>
...
@XmlType(name = "Synccom.senior.g5.dougSomaOut", propOrder = {
    "erroExecucao",
    "total"
})
public class SynccomSeniorG5DougSomaOut {
